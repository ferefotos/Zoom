...
<body>
    ...
    <div id=jskell>
        <h3>Az oldal működéséhez JavaScript szükséges!</h3><hr>
        <p>Az oldal JavaScript nélkül nem működik megfelelően! Engedélyezd a JavaScriptet a böngésződ beállításaiban! </p>
    </div>
    <script>document.getElementById("jskell").style.display="none";</script>
    <div class="container">
        <aside>
